...
public enum StandardKeywordsEnum {
  ...
  SECRET("Secret", "After you play a Secret spell card, it remains hidden until something " +
  ...
  STEALTH("Stealth", "Until they attack or deal damage, minions with Stealth may not be " +
