...
public enum OtherKeywordsEnum {
    ...
    CASTS_WHEN_DRAWN(
            "Casts When Drawn",
            "The spell card is automatically cast for no mana when "
    ...
    ECHO(
            "Echo",
            "Adds another copy of the card to the hand after it’s played. The copy "
    ...
    MAGNETIC(
            "Magnetic",
            "Playing a Magnetic minion to the left of a Mech merges the two cards "
    ...
    QUEST(
            "Quest",
            "A special type of spell card that does not take effect until certain "
    ...
    SIDEQUEST(
            "Sidequest",
            "A special type of spell card that grants a reward once certain "
